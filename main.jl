...
function ranom_population_of_length(population_size,length, min_char, max_char)
	return [random_specimen_of_length(length, min_char, max_char) for i in 1:population_size]
end

function random_specimen_of_length(length, min_char, max_char)
	return [rand(min_char:max_char) for i in 1:length]
end
...
function main(target, population_size, min_char, max_char)
	...
	random_population = ranom_population_of_length(population_size,target_length,min_char, max_char)
end
